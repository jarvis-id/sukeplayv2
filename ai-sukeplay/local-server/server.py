# server.py (Versi Helper Lokal untuk Arsitektur P2P)
import os
import time
import requests
import yt_dlp
...
# --- KONFIGURASI ---
YOUTUBE_API_KEY = "AIzaSyAXNv4AuqfrnDwqnD7ZMc3v7WEDMiWZ_hQ"
GEMINI_API_KEY = "AIzaSyCbOwJ6fZK469KJh9V58dewuF1EW9v3H5c"
PORT = 3000
...
def get_ai_intro(song_title, artist):
    # ... (Fungsi ini tetap sama persis seperti versi sebelumnya) ...
    try:
...
def search_youtube_and_get_stream(query):
    # ... (Fungsi ini juga tetap sama persis) ...
    try:
    ...
    except Exception as e: return None, "Terjadi kesalahan pada server saat mencari lagu."
